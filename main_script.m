...
angle_A = 20;
angle_E = -30;
[X,Y,Z] = sph2cart( pi*angle_A/180, pi*angle_E/180, 1 );
new_light_dir = [Y;Z;X];
new_light_dir = new_light_dir';
...
%	height_map = get_surface(surface_normals, image_size, algo_name);
%	
%	% %% Display outputs
%	display_output(albedo_image, height_map, algo_name );
%	plot_surface_normals(surface_normals, algo_name );
%	synthesize_image(new_light_dir, albedo_image, surface_normals, image_size, algo_name)
...
%% Compute height_map from surface normals
height_map_2 = get_surface(surface_normals_2, image_size, algo_name);
...
% synthesize_image(light_dirs_2(:,2), albedo_image_2, surface_normals_2, image_size, 'Question-1')
